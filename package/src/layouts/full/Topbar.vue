...
const buy_link = [
    ...
    { title: 'Buy Reactjs Version', url: 'https://adminmart.com/product/modernize-react-mui-dashboard-theme/?ref=56#product-price-section' },
    {
        ...
        url: 'https://adminmart.com/product/modernize-tailwind-nextjs-dashboard-template/?ref=56#product-price-section'
    },
    { title: 'Buy Nuxtjs Version', url: 'https://adminmart.com/product/modernize-nuxt-js-admin-dashboard/?ref=56#product-price-section' }
];
</script>
<template>
    <div class="feature-topbar w-full pa-4 bg-textSecondary w-100">
        <div class="d-flex flex-lg-row flex-column gap-3 justify-space-between align-center">
            ...
            <div class="d-flex flex-md-row flex-column align-center ga-4">
                <h5 class="text-h5">Check Modernize Premium Version</h5>
                    ...
                    <v-menu>
                        ...
                        <v-list density="compact" elevation="10">
                            <v-list-item v-for="(item, index) in preview_link" :key="index" :value="index" :href="item.url" target="_blank">
                                <v-list-item-title class="d-flex align-center gap-2 text-subtitle-1">
                    ...
                    <v-menu>
                        <template v-slot:activator="{ props }">
                            <v-btn color="primary" v-bind="props">
                                <span class="d-flex gap-2"> <ShoppingCartIcon size="20" /> Buy Now <ChevronDownIcon size="20" /> </span>
                            </v-btn>
                        </template>
                        <v-list density="compact" elevation="10">
